...
module.exports = {
    name: 'hitamkan',
    alias: ['hytamkan', 'hytamkanwaifu'],
    category: 'tools',
    description: 'Mengubah kulit karakter anime menjadi hitam',
    usage: '!hitamkan (kirim dengan gambar anime)',
    permission: 'user',
    async execute(sock, msg, args) {
        try {
            ...
            if (!msg.message?.imageMessage) {
                return await sock.sendMessage(msg.key.remoteJid, {
                    text: 'Kirim/Reply gambar anime terlebih dahulu!\n\n' +
                          '⚠️ *Format:* !hitamkan (attach gambar anime)'
                });
            }
            ...
            console.error('Error processing hitamkan command:', error);
